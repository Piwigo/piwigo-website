$(document).ready(function () {
  ...
  function updatePricingCards(type, updateUrl = true) {
    if (type === "cloud") {
      ...
      $(".professional-services-text").each(function (index) {
        console.log($(this).height());
        maxHeightProfessional =
          $(this).height() > maxHeightProfessional
            ? $(this).height()
            : maxHeightProfessional;
      });
      ...
      $(".service-price").each(function (index) {
        console.log($(this).height());
        maxHeightPrice =
          $(this).height() > maxHeightPrice ? $(this).height() : maxHeightPrice;
      });
  ...
  $(".btn-pricing").on("click", function () {
    ...
    $parent
      .find(".btn-pricing")
      .toggleClass(
        "active inactive bg-white bg-transparent shadow-sm shadow-none",
      );
  ...
  if (planParam === "self_hosted") {
    $(".btn-pricing.cloud")
      ...
      .addClass("inactive bg-transparent shadow-none");
    $(".btn-pricing.self-hosted")
      .addClass("active bg-white shadow-sm")
      .removeClass("inactive bg-transparent shadow-none");
