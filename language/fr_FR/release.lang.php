...
$lang['The list of major changes is described on <br><a class="orange-text" href="%s">Piwigo %s release note</a>'] = 'La liste des changements majeurs est décrite sur les <br><a class="orange-text" href="%s">notes de la version %s</a>.';
...
$lang['pwg_org_release16_menu_download_details'] = 'Télécharger et détails';
