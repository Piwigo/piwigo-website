...
$lang['pricing technical description'] = 'All too often, we see organizations that install Piwigo on a server and then forget about it. The result: users stuck with performance issues, updates that are never installed, or a poorly configured server.
...
$lang['pricing plan_help_admin'] = 'Administrators have access to the Piwigo administration, and thus to all the features: create / edit / delete files, albums, tags, users, access to statistics... Some super-administrators can change the look of your Piwigo and install or uninstall plugins. In Piwigo, administrators include "administrator" and "webmaster" user statuses.';
...
$lang['10GB storage'] = '10GB storage';
$lang['Image, video & audio files only'] = 'Image, video & audio files only';
$lang['Email support'] = 'Email support';

$lang['All the standard features of Piwigo'] = 'All the standard features of Piwigo';
$lang['Over 80 plugins to customize your Piwigo'] = 'Over 80 plugins to customize your Piwigo';
$lang['Host your gallery on a secure cloud'] = 'Host your gallery on a secure cloud';
$lang['Import your existing Piwigo'] = 'Import your existing Piwigo';
...
$lang['100GB storage'] = '100GB storage';
$lang['All file formats'] = 'All file formats';
$lang['Priority email support'] = 'Priority email support';

$lang['All the features of the Pro plan, but also...'] = 'All the features of the Pro plan, but also...';
$lang['Contributor management (Allow non-administrators to upload files)'] = 'Contributor management (Allow non-administrators to upload files)';
$lang["Administrators' activity history (additions, deletions, etc.)"] = "Administrators' activity history (additions, deletions, etc.)";
...
$lang['250GB storage'] = '250GB storage';

$lang['All the features of the Team plan, but also...'] = 'All the features of the Team plan, but also...';
$lang['More options for organizing, categorizing and presenting your content'] = 'More options for organizing, categorizing and presenting your content';
$lang['More automation and productivity'] = 'More automation and productivity';
$lang['More advanced features'] = 'More advanced features';
$lang['Custom data import (priced upon request)'] = 'Custom data import (priced upon request)';
$lang['Custom graphic personalization'] = 'Custom graphic personalization';
...
$lang['1000GB storage'] = '1000GB storage';
$lang['Priority email support + phone support'] = 'Priority email support + phone support';

$lang['All the features of the Enterprise plan, but also...'] = 'All the features of the Enterprise plan, but also...';
$lang['Advanced authentication features (Single sign-on, password rules...)'] = 'Advanced authentication features (Single sign-on, password rules...)';
$lang['Enhanced coaching for Piwigo implementation'] = 'Enhanced coaching for Piwigo implementation';
$lang['Custom development (priced upon request)'] = 'Custom development (priced upon request)';
$lang['Dedicated server (priced upon request)'] = 'Dedicated server (priced upon request)';
...
$lang['Access to all features, themes and plugins'] = 'Access to all features, themes and plugins';
$lang['Access to the documentation and the community forum'] = 'Access to the documentation and the community forum';


$lang['pricing card light description'] = 'For small organizations';

$lang['Professional user support via email, video call, and phone by appointment'] = 'Professional user support via email, video call, and phone by appointment';
$lang['Response time: 48 business hours'] = 'Response time: 48 business hours';
