...
<section class="container cases-header">
  <div class="row justify-content-center">
    ...
    <div class="col-md-2 col-6 text-center mb-5">
      <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/08/20260708095125-ebc291f5-me.webp"
        alt="Logo Cotentin" class="img-fluid">
    </div>
    <div class="col-md-5"></div>
      ...
      <div class="sidebar-sticky">
        <div class="version-16-nav-card" id="release_menu">
          ...
          <nav class="nav flex-column mt-3 version-16-nav-list" aria-label="On this page">
            <a class="nav-link minimenus-item icon-flash-1" href="#challenge">{'The challenge'|translate}</a>
            <a class="nav-link minimenus-item icon-pwg" href="#choice">{'The choice of Piwigo'|translate}</a>
            <a class="nav-link minimenus-item icon-star-1" href="#benefits">{'Benefits'|translate}</a>
          </nav>
    ...
    <div class="col-md-8">
      ...
      <div class="section-part justify-content-center text-center" id="challenge">
        ...
        <div class="row g-2">
          <div class="col-6">
            <img
              src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/08/20260708095126-666611cd-me.webp"
              class="mb-0 w-100 h-100 object-fit-cover rounded">
          </div>
          <div class="col-6 d-flex flex-column gap-2">
            <img
              src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/08/20260708095125-f5a51fd3-me.webp"
              class="mb-0 w-100 object-fit-cover rounded" style="height: 50%">
            <img
              src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/08/20260708095125-60b6feee-me.webp"
              class="mb-0 w-100 object-fit-cover rounded" style="height: 50%">
          </div>
        </div>
      ...
      <div class="section-framed-container" id="choice">
        ...
        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/08/20260708095124-81967142-la.webp"
          class="mb-0 w-100 object-fit-cover rounded">
      ...
      <div id="benefits" class="section-part technical-features">
        ...
        <div class="testi-card">
          ...
          <div class="testi-footer">
            ...
            <p class="name-testimonial mb-0">Christine Semilly-Lagalle <span
                class="p-testimonial testi-role mb-0">{'porg_cases_cotentin_benefits_person'|translate}</span></p>
            <a href="http://www.encotentin.fr" target="_blank" rel="noopener noreferrer"
              class="testi-author-link sector-testimonial pink-text">{'porg_cases_cotentin_benefits_structure'|translate}<i
                class="icon-ext1 secondary-pink-text ms-1"></i><i class="icon-ext2 secondary-pink-text ms-1"></i></a>
