    ...
    <div id="pricing-cloud-content" class="pricing-content-wrapper">
        <div class="pricing-main-grid">
            ...
            <div class="pricing-grid-item">
                {assign
                    var="f_pro"
                    value=[ ['text' => {'1 administrator'|translate}], ['text' => {'unlimited users'|translate}], ['text' => {'no contributors'|translate}, 'not_included' => true], ['text' => {'10GB storage'|translate}, 'info' => true], ['text' => {'Image, video & audio files only'|translate}, 'not_included' => true, 'info' => true], ['text' => {'Email support'|translate}] ] 
                }
                {assign
                    var="s_pro"
                    value=[ ['text' => {'All the standard features of Piwigo'|translate}, 'info' => true], ['text' => {'Over 80 plugins to customize your Piwigo'|translate}, 'info' => true], ['text' => {'Host your gallery on a secure cloud'|translate}, 'info' => true], ['text' => {'Import your existing Piwigo'|translate}, 'info' => true] ] 
                }
                {include
            ...
            <div class="pricing-grid-item">
                ...
                {assign
                    var="s_team"
                    value=[ ['text' => {'All the features of the Pro plan, but also...'|translate}], ['text' => {'Contributor management (Allow non-administrators to upload files)'|translate}, 'info' => true], ['text' => {"Administrators' activity history (additions, deletions, etc.)"|translate}, 'info' => true], ['text' => {'Advanced user management'|translate}, 'info' => true] ] 
                }
                {include
                    file="template/include/card/pricing_option.tpl"
                    type="cloud"
            ...
            <div class="pricing-grid-item">
                ...
                {assign
                    var="s_ent"
                    value=[ ['text' => {'All the features of the Team plan, but also...'|translate}], ['text' => {'More options for organizing, categorizing and presenting your content'|translate}, 'info' => true], ['text' => {'More automation and productivity'|translate}, 'info' => true], ['text' => {'More advanced features'|translate}, 'info' => true], ['text' => {'Custom graphic personalization'|translate}, 'info' => true], ['text' => {'Custom data import (priced upon request)'|translate}] ] 
                }
                {include
                    file="template/include/card/pricing_option.tpl"
                    is_best_deal=true
            ...
            <div class="pricing-grid-item">
                ...
                {assign
                    var="s_vip"
                    value=[ ['text' => {'All the features of the Enterprise plan, but also...'|translate}], ['text' => {'Advanced authentication features (Single sign-on, password rules...)'|translate}, 'info' => true], ['text' => {'Enhanced coaching for Piwigo implementation'|translate}, 'info' => true], ['text' => {'Custom development (priced upon request)'|translate}], ['text' => {'Dedicated server (priced upon request)'|translate}], ['text' => {'Custom data import included'|translate}, 'info' => true] ] 
                }
                {include
                    file="template/include/card/pricing_option.tpl"
                    type="cloud"
    ...
    <div id="pricing-selfhosted-content" class="pricing-content-wrapper" style="display: none;">
        <div class="pricing-main-grid">
            ...
            <div class="pricing-grid-item">
                {assign
                    var="f_free"
                    value=[ ['text' => {'Access to all features, themes and plugins'|translate}], ['text' => {'Access to the documentation and the community forum'|translate}] ] 
                }
                {include
                    file="template/include/card/pricing_option.tpl"
                    type="selfhosted"
            ...
            <div class="pricing-grid-item">
                {assign
                    var="f_light"
                    value=[ ['text' => {'Access to all features, themes and plugins'|translate}], ['text' => {'Access to the documentation and the community forum'|translate}], ['text' => {'Professional user support via email, video call, and phone by appointment'|translate}], ['text' => {'Response time: 48 business hours'|translate}], ['text' => {'3 administrators'|translate}], ['text' => {'Support included for over 100 plugins'|translate}, 'info' => true] ] 
                }
                {include
                    file="template/include/card/pricing_option.tpl"
                    type="selfhosted"
            ...
            <div class="pricing-grid-item">
                {assign
                    var="f_std"
                    value=[ ['text' => {'Access to all features, themes and plugins'|translate}], ['text' => {'Access to the documentation and the community forum'|translate}], ['text' => {'Professional user support via email, video call, and phone by appointment'|translate}], ['text' => {'Response time: 24 business hours'|translate}], ['text' => {'5 administrators'|translate}], ['text' => {'Support included on over 100 plugins and 20 Enterprise plugins'|translate}, 'info' => true] ] 
                }
                {include
                    file="template/include/card/pricing_option.tpl"
                    type="selfhosted"
