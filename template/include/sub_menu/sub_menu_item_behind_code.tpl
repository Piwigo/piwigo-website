...
<div class="menu-mega-container">
	<div class="menu-columns">
		<div class="menu-column">
			{include file='template/include/sub_menu_items/sub_menu_itemc.tpl' category_type='feature-submenu' title='About Piwigo' description='Lorem ipsum dolor sit amet' icon_svg='images/icons/pwg.svg'}

			{include file='template/include/sub_menu_items/sub_menu_itemc.tpl' category_type='feature-submenu' title='Contribute' description='Lorem ipsum dolor sit amet' icon_class=' icon-contribute'}
		</div>
	</div>
</div> *}
