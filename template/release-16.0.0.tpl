...
<script src="{$PORG_ROOT_URL_PLUGINS}js/release16.js"></script>

<section class="container release-notes-intro release-top">
  <div class="row align-items-center">
    <div class="col-12 col-md-6 release-top-left">
      <h1 class="orange-text mb-3">Piwigo 16</h1>
      <h1 class="release-title mb-4">{'pwg_org_release16_title'|translate}</h1>

      <div class="mb-2">
        {include file='template/include/buttons/button.tpl' variant='menu_btn_green' label={'Download Piwigo %s'|translate:$download_versions[0].version}
        href="//piwigo.org/download/dlcounter.php?code={$download_versions[0].version}"}
      </div>

      <p class="release-date mb-3"><i class="icon-pwg"></i> {'Released on %s'|translate:$released_on}</p>

      <a href="#download_details"
        class="release-date threec-text underlined-text">{'Download details and older versions'|translate}</a>

    </div>
    <div class="col-sm-12 col-md-6 text-center">
      <p class="intro-text intro-text2_10" id="intro-main-text">{'pwg_org_release16_intro_desc'|translate}</p>
      <p class="intro-text intro-text2_10 mb-0" id="intro-main-text">{'pwg_org_release16_intro_short_text'|translate}
      </p>
    </div>
  </div>
</section>
  ...
  <div class="row version-16-content pt-5">
      ...
      <div class="version-16-nav-card" id="release_menu">
        ...
        <nav class="nav flex-column mt-3 version-16-nav-list v16" aria-label="On this page">
          ...
          <a class="nav-link minimenus-item icon-paint"
            href="#related_tags">{'pwg_org_release16_menu_related_tags'|translate}</a>
          <a class="nav-link minimenus-item icon-paint"
            href="#save_buttons">{'pwg_org_release16_menu_mv_save_btn'|translate}</a>
          ...
          <div class="interview-nav-item">
            <a class="interview-nav-link nav-link minimenus-item icon-icon28"
              href="#interview_lana">{'Interview %s'|translate:'Lana'}</a>
          </div>
          <a class="nav-link minimenus-item icon-wrench"
            href="#technical_features">{'pwg_org_release16_menu_technical_features'|translate}</a>
          <a class="nav-link minimenus-item icon-download"
            href="#download_details">{'pwg_org_release16_menu_download_details'|translate}</a>
        </nav>
    ...
    <div class="col-md-8">
      ...
      <div class="accordion accordion-flush release-version-accordion" id="releaseVersionAccordion">
        {foreach $download_versions as $download_version}
          <div class="accordion-item mb-3 border-0">
            ...
            <div id="collapse-{$download_version.version|replace:'.':'-'}" class="accordion-collapse collapse"
              aria-labelledby="heading-{$download_version.version|replace:'.':'-'}"
              data-bs-parent="#releaseVersionAccordion">
      ...
      <div class="section-part justify-content-center text-center">
        ...
        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/07/18/20250718142136-c9b465c1-la.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_menu_std_pages_desc2'|translate}</p>

        <img src="https://ressources.piwigo.com/uploads/c/v/7/cv7jpz6hf8//2025/10/22/20251022115751-d0da63b3.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_menu_std_pages_desc3'|translate}</p>

        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/07/18/20250718142137-af445469-la.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_menu_std_pages_desc4'|translate}</p>

        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/10/22/20251022141215-e328001c-la.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_menu_std_pages_desc5'|translate}</p>

      </div>

      <div class="section-framed-container" id="2fa">
        <div class="section-part section-framed extension position-relative">
          <i class="icon-puzzle"></i>
          <h3 id="anonymous_stats" class="text-end">{'pwg_org_release16_menu_2FA_title'|translate}</h3>
          <p>{'pwg_org_release16_2FA_desc'|translate}<br>
            <br>
            {'pwg_org_release16_2FA_desc2'|translate}
          </p>
        </div>
      </div>
      ...
      <div class="section-part">
        ...
        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/10/23/20251023093729-b385447d-la.jpg"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_mv_save_btn_desc'|translate}</p>
      </div>
      ...
      <div id="interview_romain" class="interview-container">
        <div class="interview">
          ...
          <img class="photo"
            src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/10/24/20251024135944-7fcb50d8-la.jpg">
          <p>{'pwg_org_release16_interview_romain_part2'|translate}</p>
          <div class="interview-signature text-end name-testimonial"><a href=""></a>Romain</div>
        </div>
      </div>
      ...
      <div class="section-part">
        ...
        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/10/24/20251024160311-8fba20ea-sm.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_gallery_search_desc2'|translate}</p>

        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/10/24/20251024160644-db578cfd-me.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_gallery_search_desc3'|translate}</p>
      </div>

      <div class="section-part">
        <h3 id="comments_manager">{'pwg_org_release16_title_comment_manager'|translate}
          <span class="badge badge-refresh icon-paint">{'pwg_org_release16_badge_refresh'|translate}</span>

          <p class="col-sm-10 col-md-8 descriptive-text">{'pwg_org_release16_comment_manager_desc'|translate}</p>

          <img
            src="https://ressources.piwigo.com/_datas/c/v/7/cv7jpz6hf8/i/uploads/c/v/7/cv7jpz6hf8//2025/09/03/20250903114721-068b399e-xx.png"
            class="screenshot">

          <p class="sub-h3">{'pwg_org_release16_comment_manager_desc2'|translate}</p>
      </div>
      ...
      <div class="section-part">
        <h3 id="activity_log_filter">{'pwg_org_release16_title_activity_filter'|translate} <span
            class="badge badge-redesign icon-arrows-cw">{'pwg_org_release16_badge_redesign'|translate}</span></h3>

        <p class="col-sm-10 col-md-8 descriptive-text">{'pwg_org_release16_activity_filter_desc'|translate}</p>

        <img
          src=" https://ressources.piwigo.com/_datas/c/v/7/cv7jpz6hf8/i/uploads/c/v/7/cv7jpz6hf8//2025/09/05/20250905111428-599f4948-xx.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_activity_filter_desc2'|translate}</p>
      </div>

      <div class="section-part">
        <h3 id="image_update">{'pwg_org_release16_title_update_img_batches'|translate}<span
            class="badge badge-redesign icon-arrows-cw">{'pwg_org_release16_badge_redesign'|translate}</span></h3>

        <p class="col-sm-10 col-md-8 descriptive-text">{'pwg_org_release16_update_img_batches_desc'|translate}</p>

        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2025/09/03/20250903115313-73e80752-xx.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_update_img_batches_desc2'|translate}</p>
      </div>
      ...
      <div class="section-part">
        ...
        <img src="https://ressources.piwigo.com/uploads/c/v/7/cv7jpz6hf8//2025/10/07/20251007082656-d89dc25f.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_expert_mode_desc2'|translate}</p>

        <img src="https://ressources.piwigo.com/uploads/c/v/7/cv7jpz6hf8//2025/10/07/20251007082656-cafe7b58.png"
          class="screenshot">

        <p class="sub-h3">{'pwg_org_release16_expert_mode_des3'|translate}</p>
      </div>
      ...
      <div id="interview_lana" class="interview-container">
        <div class="interview">
          ...
          <img class="photo"
            src="https://ressources.piwigo.com/uploads/c/v/7/cv7jpz6hf8//2025/10/24/20251024140405-0919f0b1.jpg">
          <p>{'pwg_org_release16_interview_lana2'|translate}</p>
          <div class="interview-signature text-end name-testimonial"><a href="">Lana</a></div>
        </div>
      </div>
      ...
      <div id="technical_features" class="section-part technical-features">
        <div class="row justify-content-center">
          ...
          <p class="descriptive-text">{'pwg_org_release16_tech_features_php_min_version'|translate}</p>


          <h4 class="text-center">{'pwg_org_release16_tech_features_change_img_priority'|translate}</h4>
          <p class=" descriptive-text">
            {'pwg_org_release16_tech_features_change_img_priority_desc'|translate}</p>

          <h4 class="text-center">{'pwg_org_release16_tech_features_api_keys'|translate}</h4>
          <p class="descriptive-text">{'pwg_org_release16_api_key_desc'|translate}
            <br><br>
      ...
      <div class="table-responsive">
        <table class="table align-middle download-versions-table mb-0">
          ...
          <tbody>
            ...
            {/foreach}
            <tr>
              <td class="text-version">16.0.0</td>
