...
'title' => {'use cases association how card1 title'|translate},
  ...
  {include file='template/use_cases/parts/discover.tpl' title={'use cases discover title'|translate} description={'use cases association discover description'|translate} btn_text={'use cases discover btn text'|translate}}
