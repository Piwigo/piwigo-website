...
<section class="container release-notes-intro">
  <div class="row">
    <div class="col-sm-12 col-md-6 text-center">
      ...
      <div class="col-sm-12 col-md-6 text-center d-flex justify-content-center align-items-center" id="responsive-screens-container">
        <img class="img-fluid" id="responsive-screens" src="https://piwigo.org/screenshots/github-screenshot-2.10.jpg">
      </div>
   </div>
</section>
...
<section id="overview" class="container-fluid release-notes-overview">
  <div class="container">
    <div class="row equal user-features">
      ...
      <div class="col-xs-12">
        <h3><i class="icon-star-1"></i>User features</h3>
      </div>
      ...
      <div class="table-responsive">
        <table class="table align-middle download-versions-table mb-0">
          ...
          <tbody>
            ...
            {/foreach}
            <tr>
              <td class="text-version">2.10.0</td>
