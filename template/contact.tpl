      ...
      <div id="success" class="contact-form-success">
        <div class="contact-form-success-inner">
          ...
          <div class="success-buttons d-flex gap-md-4 gap-2">
            {include file='template/include/buttons/button.tpl' variant='cta_primary_green' label={'Discover our blog'|translate} href='https://piwigo.org/blog/'}
        ...
        <div class="form-group position-relative custom-select-wrapper">
          ...
          <div class="custom-select-options">
            <div class="custom-select-options-content">
              ...
              <div class="custom-option" data-value="Customer support request">
                <span class="custom-radio"></span>
                <span class="custom-option-label p-boxed">{'Customer support request'|translate}</span>
              </div>
