<section class="feature-section py-5">
  <div class="container">
    ...
    <div class="feature-parts-stack">
      ...
      {include file="template/include/card/global_text_image.tpl" title={'customize sub3 title'|translate} desc={'customize sub3 description1'|translate} desc2={'customize sub3 description2'|translate} image="{$PORG_ROOT_URL}images/features/customize/api.png" btn_text={'customize sub3 btn'|translate} btn_link="#" } 
