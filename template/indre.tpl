...
<section class="container cases-header">
  <div class="row justify-content-center">
    ...
    <div class="col-md-2 col-6 text-center mb-5">
      <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2022/05/11/20220511105711-334521c6-me.png" alt="Logo ect" class="img-fluid w-100">
    </div>
    <div class="col-md-4"></div>
    <div class="col-md-10 text-center">
      <h1 class="text-center">{'porg_cases_indre_title'|translate}</h1>
    </div>
  </div>
</section>
...
<section class="container mb-5">
  <div class="row version-16-content pt-5">
    ...
    <div class="col-md-8">
      ...
      <p class="mb-5">{'porg_cases_indre_description'|translate}</p>

      <div class="section-part justify-content-center text-center" id="challenge">
        <h2 class="mb-4">{'porg_cases_indre_challenge_title'|translate}</h2>

        <div class="testi-card mt-5 mb-4">
          <i class="icon-quote main-green-text"></i>
          <p class="p-testimonial testi-text mb-0">{'porg_cases_indre_challenge_text'|translate}</p>
          <div class="testi-footer">

            <p class="name-testimonial mb-0">Jean-François Lacou <span class="p-testimonial testi-role mb-0">{'porg_cases_indre_benefits_person'|translate}</span></p>
            <a href="https://www.indre.fr/fr" target="_blank" rel="noopener noreferrer" class="testi-author-link sector-testimonial pink-text">{'porg_cases_indre_benefits_structure'|translate}<i class="icon-ext1 secondary-pink-text ms-1"></i><i class="icon-ext2 secondary-pink-text ms-1"></i></a>

          </div>
        </div>

        <p class="mb-5">{'porg_cases_indre_challenge_description'|translate}</p>

        <div class="row g-2">
          <div class="col-6">
            <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709150507-34dc2c51-me.webp" class="mb-0 w-100 h-100 object-fit-cover rounded">
          </div>
          <div class="col-6 d-flex flex-column gap-2">
            <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709150508-5ff5e5c2-me.webp" class="mb-0 w-100 object-fit-cover rounded" style="height: 50%">
            <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709150506-aeaca18e-me.webp" class="mb-0 w-100 object-fit-cover rounded" style="height: 50%">
          </div>
        </div>
      ...
      <div class="section-framed-container" id="choice">
        ...
        <p class="mb-5">{'porg_cases_indre_choice_description'|translate}</p>

        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709150507-7a0fc74f-la.webp" class="mb-0 w-100 object-fit-cover rounded">
      ...
      <div id="benefits" class="section-part technical-features">
        ...
        <p class="mb-5">{'porg_cases_indre_benefits_description'|translate}</p>
        <div class="testi-card">
          <i class="icon-quote main-green-text"></i>
          <p class="p-testimonial testi-text mb-0">{'porg_cases_indre_benefits_text'|translate}</p>
          <div class="testi-footer">

            <p class="name-testimonial mb-0">Jean-François Lacou</p>
            {* <p class="p-testimonial testi-role mb-0">{'porg_cases_indre_benefits_person'|translate}</p>
            <a href="https://www.indre.fr/fr" target="_blank" rel="noopener noreferrer" class="testi-author-link sector-testimonial pink-text">{'porg_cases_indre_benefits_structure'|translate}<i class="icon-ext1 secondary-pink-text ms-1"></i><i class="icon-ext2 secondary-pink-text ms-1"></i></a>
