  ...
  <div class="row release-sub-section">
    ...
    <div class="automatic-upgrade row align-items-center">
      ...
      <div class="col-md-3 mb-5 mb-md-0 d-flex align-items-center">
        {include file='template/include/buttons/button.tpl' variant='menu_btn_green' label={'Automatic upgrade'|translate} href="{$EXT_URL.automatic_update}" target="_blank"}
      </div>
    </div>
    ...
    <div class="manual-upgrade row">
      ...
      <div class="col-md-3 mb-5 mb-md-0 d-flex align-items-center">
        {include file='template/include/buttons/button.tpl' variant='menu_btn_blue' label={'Manual Upgrade'|translate} href="{$EXT_URL.manual_update}" target="_blank"}
      </div>
    </div>
  </div>
</section>