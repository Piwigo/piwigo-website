<section class="container-fluid">
  <div class="row text-center">
    <img class="piwigo14-img px-0" src="https://sandbox.piwigo.com/uploads/4/y/1/4y1zzhnrnw//2023/10/16/20231016172415-cd74febf.png">
  </div>
</section>
      ...
      <div class="table-responsive">
        <table class="table align-middle download-versions-table mb-0">
          ...
          <tbody>
            ...
            {/foreach}
            <tr>
              <td class="text-version">14.0.0</td>
