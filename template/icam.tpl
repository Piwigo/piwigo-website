...
<section class="container cases-header">
  <div class="row justify-content-center">
    ...
    <div class="col-md-3 col-6 text-center mb-5">
      <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709111938-507d82ee-me.webp" alt="Logo ect" class="img-fluid w-100">
    </div>
    <div class="col-md-4"></div>
    <div class="col-md-10 text-center">
      <h1 class="text-center">{'porg_cases_icam_title'|translate}</h1>
    </div>
  </div>
</section>

<section class="client-full-width-banner-icam"></section>
...
<section class="container mb-5">
  <div class="row version-16-content pt-5">
    ...
    <div class="col-md-8">
      ...
      <p class="mb-5">{'porg_cases_icam_description'|translate}</p>

      <div class="section-part justify-content-center text-center" id="challenge">
        <h2 class="mb-4">{'porg_cases_icam_challenge_title'|translate}</h2>

        <p class="mb-5">{'porg_cases_icam_challenge_description'|translate}</p>

        <div class="row g-2">
          <div class="col-6">
            <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709112737-37de739c-me.webp" class="mb-0 w-100 h-100 object-fit-cover rounded">
          </div>
          <div class="col-6 d-flex flex-column gap-2">
            <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709112737-55fba061-me.webp" class="mb-0 w-100 object-fit-cover rounded" style="height: 50%">
            <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709112737-1b244867-me.webp" class="mb-0 w-100 object-fit-cover rounded" style="height: 50%">
          </div>
        </div>
      ...
      <div class="section-framed-container" id="choice">
        ...
        <p class="mb-5">{'porg_cases_icam_choice_description'|translate}</p>

        <div class="testi-card mt-5 mb-4">
          <i class="icon-quote main-green-text"></i>
          <p class="p-testimonial testi-text mb-0">{'porg_cases_icam_choice_text'|translate}</p>
          <div class="testi-footer">

            <p class="name-testimonial mb-0">Germain Dutilleul<span class="p-testimonial testi-role mb-0">{'porg_cases_icam_benefits_person'|translate}</span></p>
        ...
        <img src="https://ressources.piwigo.com/i?/uploads/c/v/7/cv7jpz6hf8//2026/07/09/20260709111936-0d128d1f-la.webp" class="mb-0 w-100 object-fit-cover rounded">
      ...
      <div id="benefits" class="section-part technical-features">
        ...
        <p class="mb-5">{'porg_cases_icam_benefits_description'|translate}</p>
        <div class="testi-card">
          <i class="icon-quote main-green-text"></i>
          <p class="p-testimonial testi-text mb-0">{'porg_cases_icam_benefits_text'|translate}</p>
          <div class="testi-footer">
