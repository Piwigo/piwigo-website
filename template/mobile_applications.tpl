...
<section class="mobile-app-album-part container">
  {include
    file="template/include/card/global_text_image.tpl"
    reverse=true
    title={'mobile_applications_albums_title'|translate} desc={'mobile_applications_albums_text'|translate} image="{$PORG_ROOT_URL}images/mobile_applications/Albums.png" 
  }
</section>
...
<section class="mobile-app-manage-part container">
  {include
    file="template/include/card/global_text_image.tpl"
    reverse=false
    title={'mobile_applications_sort_photos_title'|translate} desc={'mobile_applications_sort_photos_text'|translate} image="{$PORG_ROOT_URL}images/mobile_applications/Manage.png" 
  }
</section>
...
<section class="mobile-app-manage-part container">
  {include
    file="template/include/card/global_text_image.tpl"
    reverse=true
    title={'mobile_applications_share_title'|translate} desc={'mobile_applications_share_text'|translate} image="{$PORG_ROOT_URL}images/mobile_applications/sharing.png" 
  }
</section>
...
<section class="mobile-app-copy-part container">
  {include
    file="template/include/card/global_text_image.tpl"
    reverse=true
    title={'mobile_applications_copy_move_title'|translate} desc={'mobile_applications_copy_move_text'|translate} image="{$PORG_ROOT_URL}images/mobile_applications/Copy.png" 
  }
</section>
