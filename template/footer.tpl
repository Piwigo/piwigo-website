          ...
          <div class="footer-mobile-section">
            ...
            <div id="footerMobileNews" class="collapse footer-mobile-collapse" data-bs-parent=".footer-mobile-nav-accordion">
              <ul>
                ...
                <li><a class="footer-feature-link footer-menu-item" href="{$EXT_URL.blog}">{'Blog'|translate}</a></li>
      ...
      <div class="footer-bottom-main d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="footer-bottom-legal">
          ...
          <ul class="footer-legal-links">
            <li><a class="footer-legal-link footer-menu-item" href="{$EXT_URL.privacy}" target="_blank" rel="noopener noreferrer">{'Footer legal 1 Privacy Policy'|translate}</a></li>
            ...
            <li><a class="footer-legal-link footer-menu-item" href="{$EXT_URL.terms_of_service}" target="_blank" rel="noopener noreferrer">{'Footer legal 4 Terms of Use'|translate}</a></li>
            {* <li><a class="footer-legal-link footer-menu-item" href="{$PORG_ROOT}{$URL.gdpr}">{'Footer legal 5 GDPR'|translate}</a></li> *}
            {if substr($lang_info.code, 0, 2) == 'fr'}
              <li><a class="footer-legal-link footer-menu-item" href="{$EXT_URL.dpa}" target="_blank" rel="noopener noreferrer">{'Footer legal 6 DPA'|translate}</a></li>
            {/if}
          </ul>
        </div>
